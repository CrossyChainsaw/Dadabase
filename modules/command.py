...
LEADERBOARD_CLAN_ADD_CONSOLE_PLAYER = Command(name='ClanLB_add_console_player', description='Add a console player to the leaderboard (or any other aditional player that is not originally in the in-game clan)')
LEADERBOARD_CLAN_DATA = Command(name='ClanLB_data', description='List all the fields that are being used in the leaderboard')
LEADERBOARD_CLAN_EDIT_DATA = Command(name='ClanLB_edit_data', description='Edit clan data')
LEADERBOARD_CLAN_HIDE_PLAYER = Command(name='ClanLB_hide_player', description='Specify a player to hide from the leaderboard')
LEADERBOARD_CLAN_INIT = Command(name='ClanLB_init', description="(You aren't supposed to run this) Generate a file with clan data for the current clan server")
LEADERBOARD_CLAN_LIST_HIDDEN_PLAYERS = Command(name='ClanLB_hidden_players', description='List all players that are hidden from the leaderboard')
LEADERBOARD_CLAN_LIST_CONSOLE_PLAYERS = Command(name='ClanLB_list_console_players', description='List all console players')
LEADERBOARD_CLAN_UNHIDE_PLAYER = Command(name='ClanLB_unhide_player', description='Unhide a previously hidden player from the leaderboard')
LEADERBOARD_CLAN_REMOVE_CONSOLE_PLAYER = Command(name='ClanLB_remove_console_player', description='Remove a console player')
LEADERBOARD_COMMUNITY_ADD_PLAYER = Command(name='CommunityLB_add_player', description="(You are not supposed to run this) Manually add a player to the community leaderboard")
LEADERBOARD_COMMUNITY_EDIT_DATA = Command(name='CommunityLB_edit_data', description='Edit server data')
LEADERBOARD_COMMUNITY_INIT = Command(name='CommunityLB_init', description="(You aren't supposed to run this) Generate a file with clan data for the current community server")
LEADERBOARD_COMMUNITY_LIST_PLAYERS = Command(name='CommunityLB_list_players', description='List all community players')
LEADERBOARD_COMMUNITY_REMOVE_PLAYER = Command(name='CommunityLB_remove_player', description="(You aren't supposed to run this) Manually remove a player from the server leaderboard")
...
def get_country_code(country_name: str) -> str:
    for choice in ALL_COUNTRIES:
        if choice.name.lower() == country_name.lower():
            return choice.value
...
COUNTRIES_DICT = {
    ...
    "South Korea": "KR",
    "Spain": "ES",
    "Sri Lanka": "",  # Not in your list, just noting it's common - you can add if needed
    "Suriname": "SR",
    "Sudan": "SD",
    "Syria": "SY",
    "Sweden": "SE",
...
ALL_COUNTRIES = [
    ...
    app_commands.Choice(name="Austria", value="AT"),
    app_commands.Choice(name="Bangladesh", value="BD"),
    app_commands.Choice(name="Bolivia", value="BO"),
    app_commands.Choice(name="China", value="CN"),
    app_commands.Choice(name="Colombia", value="CO"),
    app_commands.Choice(name="Czech Republic", value="CZ"),
    app_commands.Choice(name="Denmark", value="DK"),
    app_commands.Choice(name="Egypt", value="EG"),
    app_commands.Choice(name="Finland", value="FI"),
    app_commands.Choice(name="Greece", value="GR"),
    app_commands.Choice(name="Hungary", value="HU"),
    app_commands.Choice(name="India", value="IN"),
    app_commands.Choice(name="Israel", value="IL"),
    app_commands.Choice(name="Kazakhstan", value="KZ"),
    app_commands.Choice(name="Kenya", value="KE"),
    app_commands.Choice(name="Malaysia", value="MY"),
    app_commands.Choice(name="Mexico", value="MX"),
    app_commands.Choice(name="New Zealand", value="NZ"),
    app_commands.Choice(name="Pakistan", value="PK"),
    app_commands.Choice(name="Philippines", value="PH"),
    app_commands.Choice(name="Poland", value="PL"),
    app_commands.Choice(name="Portugal", value="PT"),
