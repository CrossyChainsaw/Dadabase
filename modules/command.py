...
LEADERBOARD_CLAN_INIT = Command(name='clan_lb_init', description="(You aren't supposed to run this) Generate a file with clan data for the current clan server")
LEADERBOARD_CLAN_LIST_HIDDEN_PLAYERS = Command(name='clan_lb_hidden_players', description='List all players that are hidden from the leaderboard')
LEADERBOARD_CLAN_LIST_CONSOLE_PLAYERS = Command(name='clan_lb_list_console_players', description='List all console players')
LEADERBOARD_CLAN_UNHIDE_PLAYER = Command(name='clan_lb_unhide_player', description='Unhide a previously hidden player from the leaderboard')
LEADERBOARD_CLAN_REMOVE_CONSOLE_PLAYER = Command(name='clan_lb_remove_console_player', description='Remove a console player')
LEADERBOARD_COMMUNITY_ADD_PLAYER = Command(name='community_lb_add_player', description="(You are not supposed to run this) Manually add a player to the community leaderboard")
LEADERBOARD_COMMUNITY_EDIT_DATA = Command(name='community_lb_edit_data', description='Edit server data')
LEADERBOARD_COMMUNITY_INIT = Command(name='community_lb_init', description="(You aren't supposed to run this) Generate a file with clan data for the current community server")
LEADERBOARD_COMMUNITY_LIST_PLAYERS = Command(name='community_lb_list_players', description='List all community players')
LEADERBOARD_COMMUNITY_REMOVE_PLAYER = Command(name='community_lb_remove_player', description="(You aren't supposed to run this) Manually remove a player from the server leaderboard")
