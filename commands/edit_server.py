...
async def edit_server(interaction, leaderboard_title, sorting_method:str, show_member_count:bool,
                      show_no_elo_players:bool, channel_1v1_id:str, channel_2v2_id:str, channel_rotating_id:str, 
                      image:str, color:str, flag_type:str, show_win_loss:bool, show_legends:bool):
    # load data
